...
export const ACCEPT_INVITATION_REQUEST = "ACCEPT_IVITAION_REQUEST";
export const ACCEPT_INVITATION_FAILURE = "ACCEPT_IVITAION_FAILURE";
export const ACCEPT_INVITATION_SUCCESS = "ACCEPT_IVITAION_SUCCESS";
